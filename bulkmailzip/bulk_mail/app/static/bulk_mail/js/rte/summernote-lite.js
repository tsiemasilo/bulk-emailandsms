...
var Editor = /*#__PURE__*/function () {
  function Editor(context) {
    ...
    this.createLink = this.wrapCommand(function (linkInfo) {
      ...
      var s_title = (linkInfo.title) ? String(linkInfo.title) : "";
      ...
      external_root_jQuery_commonjs_jquery_commonjs2_jquery_amd_jquery_default().each(anchors, function (idx, anchor) {
        ...
        if (s_title) {
            external_root_jQuery_commonjs_jquery_commonjs2_jquery_amd_jquery_default()(anchor).attr('title', s_title);
        }// end of custom attribute insertion
        if (isNewWindow) {
